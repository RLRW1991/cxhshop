<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:47:"./template/mobile/new2/activity\group_list.html";i:1500893382;s:41:"./template/mobile/new2/public\header.html";i:1506063190;s:45:"./template/mobile/new2/public\header_nav.html";i:1504669655;s:45:"./template/mobile/new2/public\footer_nav.html";i:1506065382;s:43:"./template/mobile/new2/public\wx_share.html";i:1500893382;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
...
<script>
    ...
    function clock11(key){
        ...
        <!--广告图片-s-->
		<div class="banner">
            <?php $pid =204;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1507532400 and end_time > 1507532400 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
...
foreach($result as $key=>$v1):       
    ...
    ?>
		...
		<div class="gg2">
			<ul>
                <?php $pid =205;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1507532400 and end_time > 1507532400 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$v):       
    ...
    ?>
                ...
                <?php endforeach; $pid =206;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1507532400 and end_time > 1507532400 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$v):       
    ...
    ?>
		...
		<div class="banner borltrt">
            <?php $pid =207;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1507532400 and end_time > 1507532400 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$v):       
    ...
    ?>
		...
		<div class="th3 p">
			<ul>
                <!--广告小图（3张）-s-->
                <?php $pid =208;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1507532400 and end_time > 1507532400 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("3")->select();
if(!in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
		...
		<div class="floor guesslike groupquess dic">
			<div class="likeshop">
				<ul>
					...
					<li>
						<a href="<?php echo U('Activity/group',array('id'=>$v[goods_id])); ?>">
							<div class="similer-product">
								<div class="zjj close">
