<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:42:"./application/admin/view2/index\index.html";i:1506071720;s:45:"./application/admin/view2/public\menubox.html";i:1500893374;s:42:"./application/admin/view2/public\left.html";i:1505962364;}*/ ?>
<!doctype html>
<html>
<head>
...
<!--      <li data-param="mobile"><a href="javascript:void(0);">模板</a></li>-->
  ...
  <div class="admincp-header-r">
    <div class="manager">
      ...
      <dl>
        <dt class="name"></dt>
        <dd class="group" style="line-height: 30px;">管理员（<?php echo $admin_info['user_name']; ?>）</dd>
      </dl>
      <span class="avatar">
      <!-- 屏蔽管理员头像上传 -->
